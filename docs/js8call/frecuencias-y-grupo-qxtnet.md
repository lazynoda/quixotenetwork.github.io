...
Todas las pruebas y comunicaciones dentro de la red se coordinan mediante el grupo @QXTNET que tienes que dar de alta en JS8Call.

Actualmente tenemos estaciones con balizas para el grupo @QXTNET en:

:::info
- Banda Ciudadana (27,265 MHz USB - Canal 26)
- Banda 20 metros (14,078 MHz USB)
- Banda 40 metros (7,078 MHz USB)
:::
